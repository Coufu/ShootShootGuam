...
.service('SSDaysService', function() {
	var self = this;

	self.getDayOfWeekInt = function(daysToAdd) {
		daysToAdd = daysToAdd || 0;

		var theDate = new Date();
		var theActualDay = theDate.getDay();
		theActualDay = theActualDay + daysToAdd;

		var theHours = theDate.getHours();

		// if it's before 5am, make the day yesterday
		if(theHours < 5) {
			theActualDay = theActualDay + 6;
		}

		// Making sure the Day doesn't go above 6
		theActualDay = theActualDay % 7;

		return theActualDay;
	};

	self.getDayOfWeekStr = function(daysToAdd) {
		daysToAdd = daysToAdd || 0;

		var daysOfTheWeek = ["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"];

		var theActualDayInt = self.getDayOfWeekInt(daysToAdd);

		return daysOfTheWeek[theActualDayInt];
	};
})

///////////////////////////////////////////////////////////////////////////////
// ION FULL APP SERVICES
///////////////////////////////////////////////////////////////////////////////
